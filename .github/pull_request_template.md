...
#### 기타 외 
- [ ] 도메인 규칙의 도메인 객체 내부 캡슐화를 했는가?
- [ ] 의미 있는 커스텀 예외 정의 및 일관된 처리가 되었는가?
- [ ] README를 통한 아키텍처 선택 근거 및 설계 의도 문서화를 작성했는가?
- [ ] Mock/Stub을 활용한 격리된 단위 테스트 작성를 했는가?
- [ ] 패키지 구조의 일관성 및 명확한 계층 분리가 되었는가?
---
### **구현 완료 기능** :pencil:
