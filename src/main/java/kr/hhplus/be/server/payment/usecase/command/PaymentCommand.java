...
@Builder
public record PaymentCommand(Long paymentId, Long userId, Long orderId, Long orderItemId, Long couponId, Long productId) implements LockKeyProvider{
    ...
    public String lockKey() {
        return "payment:register:" + paymentId +":lock";
    }
}
