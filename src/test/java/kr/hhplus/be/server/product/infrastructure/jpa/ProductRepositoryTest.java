...
//    @Autowired private JpaPaymentRepository jpaPaymentRepository;
//    @Autowired private JpaOrderItemRepository jpaOrderItemRepository;
...
//        Product product1 = jpaProductRepository.save(ProductStep.defaultProduct());
//        Product product2 = jpaProductRepository.save(ProductStep.defaultProduct());
//        Product product3 = jpaProductRepository.save(ProductStep.defaultProduct());
//        Product product4 = jpaProductRepository.save(ProductStep.defaultProduct());
//
//        /**
//         * 예상 스코어
//         * product1 : 3
